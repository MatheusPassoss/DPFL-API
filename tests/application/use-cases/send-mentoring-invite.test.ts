...
describe("Send Mentoring Invite use case tests", () => {
   ...
   it("Deve criar e enviar o e-mail, com fé vai funcionar...", async () => {
      
      const teste = await sendMentoringInvite.execute({idStudent: "100052000-6118-123c-8e49-138e71643fa", idMentor: "21052000-6118-123c-8e49-138e71643fa"})
